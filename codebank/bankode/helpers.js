<<<<<<< HEAD
// ESM Helper module for Supabase initialization
/**
 * Wait for Supabase v2 client to be ready
 * @param {number} timeout - Timeout in milliseconds
 * @returns {Promise<Object>} - Resolved with Supabase client
 */
...
/**
<<<<<<< HEAD
 * Wait for both Supabase and DOM to be ready
 * @param {number} timeout - Supabase timeout in milliseconds
 * @returns {Promise<Object>} - Supabase client
 */
export async function waitForSupabaseAndDOM(timeout = 5000) {
  await waitForSupabase(timeout);
  await waitForDOM();
  return window.supabase;
=======
