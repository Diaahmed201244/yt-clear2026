(function() {
  ...
  class GuardianDog3D {
    constructor(containerId = 'guardian-dog-container') {
      ...
      if (!container) {
        console.warn('[Guardian3D] Container not found, creating fallback:', containerId);
        // Create fallback container (from actly.md)
        container = document.createElement('div');
        container.id = containerId;
        container.style.cssText = 'position:fixed;bottom:10px;right:10px;width:100px;height:100px;z-index:9999;pointer-events:none;';
