...
class ServiceManager {
  ...
  unmount(serviceId) {
    ...
    if (iframe) {
      ...
      // 🚨 GPU FIX: Clear src to release video/GPU resources before removing
      ...
      // Remove from mounted map to allow garbage collection
      this.mountedIframes.delete(serviceId);
