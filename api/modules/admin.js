...
import { requireRole, adminLimiter, requireGateValid } from '../middleware/admin.js'
...
router.use(async (req, _res, next) => {
  await audit(req, { action: 'ADMIN_API_ACCESS', target_type: 'endpoint', target_id: `${req.method} ${req.path}` })
  next()
=======
