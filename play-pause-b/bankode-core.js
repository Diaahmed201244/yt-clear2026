...
<<<<<<< HEAD
  function genCode() {
    ...
    if (lastDash !== -1 && lastDash === s.length - 3) {
      s = s.slice(0, lastDash + 1) + suffix;
    }
    try { console.log('[CODEGEN]', { isAuth, isOnline: online, suffix, finalCode: s }); } catch(_){}
    return s;
=======
...
<<<<<<< HEAD
  try { Bankode.startSession(); } catch(_) {}
})();
=======
